...
function renderFavorites(page = 1) {
  ...
  <div class="exercise-card-info">
    <p class="exercise-card-info-p1"><span>Burned calories:</span> ${capitalizeFirstLetter(ex.burnedCalories + ' / 3 min')}</p>
    <p class="exercise-card-info-p2"><span>Body part:</span> ${capitalizeFirstLetter(ex.bodyPart)}</p>
    <p class="exercise-card-info-p3"><span>Target:</span>${capitalizeFirstLetter(ex.target)}</p>
  </div>
</li>`,
    )
    .join('');
  ...
  if (totalPages > 3) {
    ...
    <div class="pagination-group">
      <button class="nav-btn" data-action="first" ${page === 1 ? 'disabled' : ''}>
      ...
      <button class="nav-btn" data-action="prev" ${page === 1 ? 'disabled' : ''}>
    ...
    <div class="pagination-group">
      <button class="nav-btn" data-action="next" ${page === totalPages ? 'disabled' : ''}>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <button class="nav-btn" data-action="last" ${page === totalPages ? 'disabled' : ''}>
        <svg width="31" height="24" viewBox="0 0 31 24" fill="none" xmlns="http://www.w3.org/2000/svg">
